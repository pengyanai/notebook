...
tags: [synology, security, hardening, firewall, ssh, telnet, smb, dsm, audit]
description: >
...
同一台 Synology NAS（DSM 7.x, SA6400），在完成 [Tailscale 组网和 WebDAV 部署](/posts/2026-05-10-tailscale-synology-nas-real-world.html) 后，进行了一次完整的安全审计。
