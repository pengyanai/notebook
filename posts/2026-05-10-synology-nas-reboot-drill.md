...
tags: [synology, reboot, raid, btrfs, scemd, synopkg, troubleshooting, docker, gfw]
description: >
...
[上一篇 GFW 审计博文](/posts/2026-05-10-synology-nas-gfw-audit-mihomo.html) 收尾时做了 NAS 重启演练，验证 mihomo TUN、Cloud Sync、Container Manager 等组件在重启后能否自动恢复。
