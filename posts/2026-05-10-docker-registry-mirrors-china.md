...
tags: [docker, registry, mirror, china, gfw, synology]
description: >
...
[前三篇 NAS 博文](/posts/2026-05-10-synology-nas-advanced-exploration.html) 规划了 Docker 容器扩展路线，但在实际 `docker pull` 时发现 Docker Hub (`registry-1.docker.io`) 被墙，所有国内传统镜像站也大面积停服。需要找到 2026 年仍可用的镜像加速方案。
