...
>
> 姊妹篇：[训推加速系列导航](.#)（在做） · [GPU/NCCL SOP](/posts/2026-05-07-training-inference-acceleration-troubleshooting-sop.html) · [Python CPU SOP](/posts/2026-05-07-python-cpu-bottleneck-troubleshooting-sop.html)
...
- **TGS 高 + GPU 数多** → 扩展性好
- **TGS 随 GPU 数增加反而下降** → 通信瓶颈或 overlap 做得差（[见 GPU SOP §四 NCCL](/posts/2026-05-07-training-inference-acceleration-troubleshooting-sop.html)）
...
- 系列：
  ...
  - [CPU 侧排障 SOP](/posts/2026-05-07-python-cpu-bottleneck-troubleshooting-sop.html)
  - [CUDA Graph 实战](/posts/2026-05-08-cuda-graph-qwen3-dense.html)
