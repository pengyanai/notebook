...
tags: [synology, gfw, mihomo, clash, proxy, docker, github, audit]
description: >
...
[上一篇 Docker 镜像加速](/posts/2026-05-10-docker-registry-mirrors-china.html) 解决了 `docker pull` 的问题，但 NAS 上还有更多服务受 GFW 影响——Git clone 超时、raw 脚本下载失败、部分容器注册表不可达。
...
与 [Docker 镜像加速](/posts/2026-05-10-docker-registry-mirrors-china.html) 博文配套食用。整体反墙架构演进：
...
> 与 NAS 系列联动：mihomo TUN 打通后，[之前的自建 DERP 计划](/posts/2026-05-10-synology-nas-advanced-exploration.html)（Task 13）的 AWS EC2 新加坡节点也可以通过代理 SSH 部署。GitHub 可达性为后续 Gitea + Docsify 文档流水线扫清了障碍。Cloud Sync 恢复后，NAS 可以正常同步国内外多网盘。
