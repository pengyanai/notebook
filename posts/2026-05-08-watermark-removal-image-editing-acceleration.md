...
tags: [Inpainting, Watermark Removal, InstructPix2Pix, Flux Fill, BrushNet, PowerPaint, SDEdit, ControlNet]
mermaid: true
---
...
>
> 姊妹篇：[训推加速技术地图](/posts/2026-05-08-training-inference-acceleration-map.html) · [图像 Diffusion 深化](/posts/2026-05-08-image-diffusion-acceleration-flux-sd3-dmd2.html) · [分割模型](/posts/2026-05-08-segmentation-sam2-training-acceleration.html)
>
...
训练加速点和 [图像 Diffusion 篇](/posts/2026-05-08-image-diffusion-acceleration-flux-sd3-dmd2.html) 一致：
- **bf16 + FSDP2**
- **SageAttention**
...
- [图像 Diffusion 深化](/posts/2026-05-08-image-diffusion-acceleration-flux-sd3-dmd2.html)（共享步数蒸馏 / SageAttention）
- [视觉分割模型](/posts/2026-05-08-segmentation-sam2-training-acceleration.html)（上游 mask 来源）
