...
tags: [Video Diffusion, Wan 2.2, HunyuanVideo, VSA, SLA, 3D Gaussian Splatting, FastVideo, FastWan, CogVideoX, Mochi]
mermaid: true
---

> 训推加速系列深化之"视频 & 3D 扩散"专题。视频时间维 + 3D 空间维让 attention 复杂度直接上升 1~2 个数量级——**这是一套独立于图像 Diffusion 的加速体系**。
>
> 姊妹篇：[图像 Diffusion 深化](/posts/2026-05-08-image-diffusion-acceleration-flux-sd3-dmd2.html)（先看这篇理解基础）· [训推加速技术地图](/posts/2026-05-08-training-inference-acceleration-map.html)
>
