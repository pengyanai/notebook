...
> 前篇：[训推加速 Qwen3 实战：看懂模型结构 + 识别算子融合机会](/posts/2026-05-07-qwen3-understand-model-identify-fusion.html)
>
...
- 系列姊妹篇：
  - [训推加速 Qwen3 实战：看懂模型 + 识别融合机会（前篇）](/posts/2026-05-07-qwen3-understand-model-identify-fusion.html)
  - [训推加速 GPU/NCCL 侧 SOP](/posts/2026-05-07-training-inference-acceleration-troubleshooting-sop.html)
  - [训推加速 Python 侧排障 SOP](/posts/2026-05-07-python-cpu-bottleneck-troubleshooting-sop.html)
