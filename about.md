...
This is **Joseph's Notebook** — a place to document ideas, experiments, and learnings. I write about **deep learning**, **LLMs**, **AI/ML infrastructure**, and related topics. Occasionally you'll find notes on SRE, distributed systems, and other tech that catches my interest.

## Interests

- Large language models and transformers
- RAG, embeddings, and retrieval systems
- Model training, quantization, and inference optimization
- Coding agents and AI tooling

## Links

- [GitHub](https://github.com/pengyanai) — source and discussions
- Blog content is driven by [GitHub Issues](https://github.com/pengyanai/notebook/issues) — feel free to open one for discussion
